...
export const ExamplesIndex: Record<string, Record<string, any>> = {
  radix: {
    ...
    "input-quiet": {
      name: "input-quiet",
      filePath: "examples/radix/input-quiet.tsx",
      component: React.lazy(async () => {
        const mod = await import("./radix/input-quiet")
        const exportName =
          Object.keys(mod).find(
            (key) =>
              typeof mod[key] === "function" || typeof mod[key] === "object"
  ...
  base: {
    ...
    "input-quiet": {
      name: "input-quiet",
      filePath: "examples/base/input-quiet.tsx",
      component: React.lazy(async () => {
        const mod = await import("./base/input-quiet")
        const exportName =
          Object.keys(mod).find(
            (key) =>
              typeof mod[key] === "function" || typeof mod[key] === "object"
