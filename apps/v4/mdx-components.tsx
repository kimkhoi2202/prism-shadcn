...
import { DEFAULT_COMPONENTS_BASE, type PageTreeFolder } from "@/lib/page-tree"
...
// This is only used on /docs/components/ index page, so default to Base UI.
function ComponentsListWrapper() {
  ...
  return (
    <ComponentsList
      ...
      currentBase={DEFAULT_COMPONENTS_BASE}
    />
  )
}
