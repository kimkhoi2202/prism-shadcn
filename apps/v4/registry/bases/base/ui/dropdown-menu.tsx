    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "cn-dropdown-menu-content cn-dropdown-menu-content-logical cn-menu-target cn-menu-translucent z-50 w-max origin-(--transform-origin) overflow-hidden outline-none",
            className
          )}
          {...props}
        >
          <div
            ...
            className="cn-dropdown-menu-viewport max-h-[calc(var(--available-height)-0.5rem)] overflow-x-hidden overflow-y-auto"
          >
            {children}
          </div>
        </MenuPrimitive.Popup>
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "cn-dropdown-menu-sub-trigger flex cursor-pointer items-center outline-hidden select-none data-popup-open:bg-accent data-popup-open:text-accent-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
