  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          "cn-dropdown-menu-content cn-menu-target cn-menu-translucent z-50 w-max origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden",
          className
        )}
        {...props}
      >
        <div
          ...
          className="cn-dropdown-menu-viewport max-h-[calc(var(--radix-dropdown-menu-content-available-height)-0.5rem)] overflow-x-hidden overflow-y-auto"
        >
          {children}
        </div>
      </DropdownMenuPrimitive.Content>
