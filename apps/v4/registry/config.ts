...
export const POINTER_CURSOR_SELECTOR =
  ':where(button, [role="button"], [role="menuitem"], [role="option"], [role="tab"], summary, a[href], [data-slot$="-trigger"], [data-slot$="-item"], [data-slot="dialog-close"], [data-slot="alert-dialog-action"], [data-slot="alert-dialog-cancel"]):not(:disabled):not([aria-disabled="true"]):not([data-disabled])'
